...
<head>
    ...
    <title>หน้าหลัก - จัดการอุปกรณ์</title>
    ...
    <nav class="navbar navbar-expand-lg navbar-glass sticky-top">
        <div class="container-fluid">
            <a class="navbar-brand d-flex align-items-center" href="index.php">
                ...
                <span class="fw-bold">ระบบอุปกรณ์</span>
            </a>
    ...
    <div class="d-flex">
            ...
            <div class="p-3">
                ...
                <?php if ($_SESSION['role'] == 'admin'): ?>
                    ...
                    <a href="equipment_categories.php" class="sidebar-item">
                        <i class="fas fa-tags me-3"></i> ประเภทอุปกรณ์
                    </a>
                    <a href="equipment.php" class="sidebar-item">
                        <i class="fas fa-desktop me-3"></i> ชื่ออุปกรณ์
                    </a>
        ...
        <div class="flex-grow-1 content-area">
            ...
            <div class="welcome-banner">
                ...
                <p class="mb-0">ยินดีต้อนรับเข้าสู่ระบบจัดการทรัพยากรและแจ้งซ่อมไอที</p>
            </div>
