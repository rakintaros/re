    ...
    if (isset($_POST['action'])) {
        switch ($_POST['action']) {
            case 'add':
                ...
                $sql = "INSERT INTO equipment_categories (name, description) VALUES ('$name', '$description')";
                if (mysqli_query($conn, $sql)) {
                    $_SESSION['success'] = "เพิ่มประเภทครุภัณฑ์สำเร็จ";
                } else {
            ...
            case 'edit':
                ...
                $sql = "UPDATE equipment_categories SET name = '$name', description = '$description' WHERE id = $id";
                if (mysqli_query($conn, $sql)) {
                    $_SESSION['success'] = "แก้ไขประเภทครุภัณฑ์สำเร็จ";
                } else {
                    $_SESSION['error'] = "เกิดข้อผิดพลาด: " . mysqli_error($conn);
                }
                break;
            ...
            case 'delete':
                ...
                // ตรวจสอบว่ามีครุภัณฑ์ใช้ประเภทนี้หรือไม่
                $check_sql = "SELECT COUNT(*) as count FROM equipment WHERE category_id = $id";
                $check_result = mysqli_query($conn, $check_sql);
                $count = mysqli_fetch_assoc($check_result)['count'];
                
                if ($count > 0) {
                    $_SESSION['error'] = "ไม่สามารถลบได้ เนื่องจากมีครุภัณฑ์ใช้ประเภทนี้อยู่";
                } else {
                    $sql = "DELETE FROM equipment_categories WHERE id = $id";
                    if (mysqli_query($conn, $sql)) {
                        $_SESSION['success'] = "ลบประเภทครุภัณฑ์สำเร็จ";
                    } else {
                        $_SESSION['error'] = "เกิดข้อผิดพลาด: " . mysqli_error($conn);
                    }
                }
        ...
        header("Location: equipment_categories.php");
        exit();
    }
}
...
<head>
    ...
    <title>จัดการประเภทครุภัณฑ์ - ระบบจัดการครุภัณฑ์</title>
    ...
    <div class="d-flex">
        ...
        <div class="sidebar" style="width: 280px;">
            <div class="p-3">
                ...
                <a href="equipment_categories.php" class="sidebar-item active">
        ...
        <div class="flex-grow-1 content-area">
            ...
            <div class="glass-card p-4">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h5 class="mb-0">รายการประเภทครุภัณฑ์</h5>
                ...
                <div class="table-responsive">
                    <table class="table table-hover table-glass">
                        <thead>
                            <tr>
                                <th width="5%">#</th>
                                <th width="25%">ชื่อประเภท</th>
                                <th width="40%">รายละเอียด</th>
                                <th width="15%">จำนวนครุภัณฑ์</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="stat-badge">
                                            <?php echo number_format($row['equipment_count']); ?> รายการ
                                        </span>
                                    </td>
            ...
            <div class="modal-content">
                ...
                <form method="POST" action="">
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <label for="add_name" class="form-label">ชื่อประเภท <span class="text-danger">*</span></label>
            ...
            <div class="modal-content">
                ...
                <form method="POST" action="">
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <label for="edit_name" class="form-label">ชื่อประเภท <span class="text-danger">*</span></label>
